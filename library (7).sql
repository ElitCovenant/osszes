...
--
-- Gép: 127.0.0.1:3306
-- Létrehozás ideje: 2024. Feb 07. 09:18
...
CREATE TRIGGER `book_AFTER_UPDATE` AFTER UPDATE ON `book` FOR EACH ROW BEGIN
	insert into library.loan_history (book_id, user_id, date) values (new.id, new.user_id, NOW());
END
$$
DELIMITER ;
...
(1, '2024-01-18', '2034-01-01', 'ambrusk@kkszki.hu', 'admin1', 'asdgfhjhgfdsewghjtrewerrehtjhgfddfsdg', 1, 1),
(2, '2023-09-01', '2024-06-16', 'valami@kkszki.hu', 'proba', 'wertzjzhterwqretuzitureqwrtzu', 2, 4);
